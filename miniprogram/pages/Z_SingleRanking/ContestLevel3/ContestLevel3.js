...
Page({
  ...
  IsReady() {
    ...
    if (app.globalData.IsChatRoomReady == 0 || app.globalData.IsMatchReady == 0 || app.globalData.IsMatchSendInfoReady == 0) {
      ...
      that.setData({
        ...
        chatScrollViewHeight: '',
        infoScrollViewHeight: '',
        newsScrollViewHeight: ''
      })
  ...
  calculateScrollViewHeight() {
    ...
    query.exec((res) => {
      ...
      console.log("Success Getting Height");
      ...
      //let infoScrollViewHeight = wx.getSystemInfoSync().screenHeight - selectBarTop - selectBarHeight - 10;

      let chatScrollViewHeight = wx.getSystemInfoSync().screenHeight - 10;
      let infoScrollViewHeight = wx.getSystemInfoSync().screenHeight - 10;
