...
Page({
  ...
  IsReady() {
    ...
    if (app.globalData.IsChatRoomReady == 0 || app.globalData.IsMatchReady == 0 || app.globalData.IsMatchSendInfoReady == 0) {
      ...
      console.log("app.TempData.MatchInfo[0]",app.TempData.MatchInfo[0])
      console.log("app.TempData.ChatRoom[0]._id",app.TempData.ChatRoom[0])
      that.setData({
        loadModal:false,
  ...
  ChangeScoreByBtn: function(e) {
    ...
    switch(e.currentTarget.dataset.case){
      case "1":
        ...
        var NewScore = this.data.TeamAScore;
        NewScore++;
        that.setData({
          TeamAScore: NewScore,
        })
        var ResultId = that.data.MatchResultId
        CF.UpdateTeamAScore(ResultId, NewScore,[]);
        console.log("A+1");
        break;
      case "2":
        //A队score = TeamAScore - 1
      ...
      case "3":
        ...
        var NewScore = this.data.TeamBScore;
        NewScore++;
        that.setData({
          TeamBScore: NewScore,
        })
  ...
  BindNewTeamAScoreChange: function (e) {
    ...
    console.log("this.data.TeamAScore", this.data.TeamAScore)
    CF.UpdateTeamAScore(ResultId, this.data.TeamAScore,[]);
  },
  BindNewTeamBScoreChange: function (e) {
    ...
    var ResultId = this.data.MatchResultId
    CF.UpdateTeamBScore(ResultId, this.data.TeamBScore,[]);
  },
...
AddTeamAMember(e) {
  ...
  // this.IsAddTeamBMemberReady();
},
// IsAddTeamAMemberReady(){
//   console.log("app.globalData.IsAddTeamAMemberReady",app.globalData.IsAddTeamAMemberReady)
//   if(app.globalData.IsAddTeamAMemberReady==0){
//     this.IsAddTeamAMemberReady();
//   }else{
//     app.globalData.IsAddTeamAMemberReady = 0;
//     wx.hideLoading();
//     wx.showToast({
//       title: '添加成功',
//     })
//   }
// },
// IsAddTeamBMemberReady(){
//   var that = this;
//   console.log("app.globalData.IsAddTeamBMemberReady",app.globalData.IsAddTeamBMemberReady)
//   if(app.globalData.IsAddTeamBMemberReady==0){
//     setTimeout(function(){
//       that.IsAddTeamBMemberReady();
//     },100)
//   }else{
//     app.globalData.IsAddTeamBMemberReady = 0;
//     wx.hideLoading();
//   }
// },
AddTeamBMember(e) {
